# =============================================================================
# 08_module_score_VMRC.R
# Score VMRC-LCD-derived pseudotime gene modules on the tissue UMAP
...
pdf_out <- file.path(output_dir, "sketch_harmony1.5_VMRC_ModuleScore.pdf")
...
if (length(gene_lists_used) == 0) {
  stop("No genes from the VMRC-LCD gene lists were found in the Seurat object.")
}
...
for (nm in names(gene_lists_used)) {
  ...
  # AddModuleScore appends "1" (e.g. VMRC_Cluster11); rename to VMRC_Cluster1
...
# Check
# =====================================================================
message("VMRC module score columns:")
print(grep("^VMRC_Cluster", colnames(merged@meta.data), value = TRUE))

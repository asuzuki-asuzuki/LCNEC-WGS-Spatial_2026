...
# Load Seurat objects
lung_t1 <- readRDS("<DIR1>/lung_xenium.rds")
lung_t2 <- readRDS("<DIR2>/lung_xenium.rds")
lung_t3 <- readRDS("<DIR3>/lung_xenium.rds")
lung_t4 <- readRDS("<DIR4>/lung_xenium.rds")
lung_t5 <- readRDS("<DIR5>/lung_xenium.rds")
lung_t6 <- readRDS("<DIR6>/lung_xenium.rds")
lung_t7 <- readRDS("<DIR7>/lung_xenium.rds")
lung_t8 <- readRDS("<DIR8>/lung_xenium.rds")
lung_t9 <- readRDS("<DIR9>/lung_xenium.rds")
lung_t10 <- readRDS("<DIR10>/lung_xenium.rds")
lung_t11 <- readRDS("<DIR11>/lung_xenium.rds")
lung_t12 <- readRDS("<DIR12>/lung_xenium.rds")
lung_t13 <- readRDS("<DIR13>/lung_xenium.rds")
lung_t14 <- readRDS("<DIR14>/lung_xenium.rds")
lung_t15 <- readRDS("<DIR15>/lung_xenium.rds")
lung_t16_a <- readRDS("<DIR16a>/lung_xenium.rds")
lung_t16_b <- readRDS("<DIR16b>/lung_xenium.rds")
lung_t17 <- readRDS("<DIR17>/lung_xenium.rds")
lung_t18 <- readRDS("<DIR18>/lung_xenium.rds")
lung_t19_a <- readRDS("<DIR19a>/lung_xenium.rds")
lung_t19_b <- readRDS("<DIR19b>/lung_xenium.rds")
lung_t20 <- readRDS("<DIR20>/lung_xenium.rds")
lung_t21 <- readRDS("<DIR21>/lung_xenium.rds")
lung_t22 <- readRDS("<DIR22>/lung_xenium.rds")
lung_t23 <- readRDS("<DIR23>/lung_xenium.rds")
lung_t24 <- readRDS("<DIR24>/lung_xenium.rds")
lung_t25 <- readRDS("<DIR25>/lung_xenium.rds")
lung_t25_2 <- readRDS("<DIR25_2>/lung_xenium.rds")
lung_t26 <- readRDS("<DIR26>/lung_xenium.rds")
lung_t27 <- readRDS("<DIR27>/lung_xenium.rds")
lung_j10 <- readRDS("<DIR28>/lung_xenium.rds")
lung_j23 <- readRDS("<DIR29>/lung_xenium.rds")
lung_j25 <- readRDS("<DIR30>/lung_xenium.rds")
lung_j27 <- readRDS("<DIR31>/lung_xenium.rds")
lung_j28 <- readRDS("<DIR32>/lung_xenium.rds")
lung_j29 <- readRDS("<DIR33>/lung_xenium.rds")
lung_j33 <- readRDS("<DIR34>/lung_xenium.rds")
# Total of 37 objects
